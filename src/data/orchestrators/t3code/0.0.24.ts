...
const data: OrchestratorVersion = {
  ...
  features: [
    ...
    },
    {
      ...
      sourceExtract: 'T3 Code runs as a Node.js WebSocket server that wraps codex app-server (JSON-RPC over stdio) and serves a React web app.',
    },
    {
      ...
      sourceExtract: 'Run without installing: `npx t3`. Desktop app: install the latest version of the desktop app from GitHub Releases.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://t3.codes/',
      sourceExtract: 'Orchestrate Claude Code, Codex, OpenCode and Cursor from one surface. Bring your own subscription. […] No keys resold. No quota caps.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://t3.codes/',
      sourceExtract: 'One button to commit, push, and make a PR. […] one button opens the PR on GitHub with a generated title, body and changelog. Auto-generated PR titles & bodies. Draft PRs, stack PRs, amend PRs.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/.docs/architecture.md',
      sourceExtract: 'Provider-native events are pulled back into the server by ProviderRuntimeIngestion, which converts them into orchestration events. […] Server pushes those updates to the browser through ServerPushBus on channels defined in orchestration.ts.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://t3.codes/',
      sourceExtract: 'T3 Code is free, open source and fast. Install it, plug in the harness you already pay for, and let your agents get to work.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/REMOTE.md',
      sourceExtract: 'Headless Server (CLI) — Use this when you want to run the server without a GUI, for example on a remote machine over SSH. Run the server with `t3 serve`.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: '`chat.new`: create a new chat thread preserving the active thread\'s branch/worktree state.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/KEYBINDINGS.md',
      sourceExtract: '`chat.newLocal`: create a new chat thread for the active project in a new environment (local/worktree determined by app settings (default `local`)).',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/packages/contracts/src/orchestration.ts',
      sourceExtract: 'export const ProjectScript = Schema.Struct({ id, name, command, icon, runOnWorktreeCreate: Schema.Boolean });',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/README.md',
      sourceExtract: 'T3 Code currently supports Codex, Claude, and OpenCode. Install and authenticate at least one provider before use: Codex CLI (codex login), Claude Code (claude auth login), OpenCode (opencode auth login).',
    },
    {
      ...
      sourceExtract: '<Toggle aria-label={diffIgnoreWhitespace ? "Show whitespace changes" : "Hide whitespace changes"} pressed={diffIgnoreWhitespace} […]> <PilcrowIcon />',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/KEYBINDINGS.md',
      sourceExtract: '`terminal.toggle`: open/close terminal drawer. `terminal.split`: split terminal. `terminal.new`: create new terminal. `terminal.close`: close/kill the focused terminal.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/KEYBINDINGS.md',
      sourceExtract: '`editor.openFavorite`: open current project/worktree in the last-used editor.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'formatProviderSkillInstallSource — distinguishes App, System, Project and Personal install sources for provider skills.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/docs/source-control-providers.md',
      sourceExtract: 'See if your current branch already has an open PR/MR […] open reviews directly in your browser.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/REMOTE.md',
      sourceExtract: 'Use this when you want to connect to a T3 Code server from another device such as a phone, tablet, or separate desktop app. […] scan the QR code on your phone.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/apps/web/src/components/chat/ContextWindowMeter.tsx',
      sourceExtract: 'import { type ContextWindowSnapshot, formatContextWindowTokens } from "~/lib/contextWindow"; function formatPercentage(value: number | null) […]',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'T3 Code is currently Codex-first. The server starts `codex app-server` (JSON-RPC over stdio) per provider session, then streams structured events to the browser through WebSocket push messages.',
    },
    {
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://t3.codes/',
      sourceExtract: 'If you don\'t like something, fork it. T3 Code is as open as they come. We built this app to be modifiable, customizable, and forkable.',
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://github.com/pingdotgg/t3code/blob/main/KEYBINDINGS.md',
      sourceExtract: '`chat.newLocal`: create a new chat thread for the active project in a new environment.',
    },
    {
