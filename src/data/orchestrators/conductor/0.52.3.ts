...
const data: OrchestratorVersion = {
  ...
  platformSources: {
    macos: {
      ...
      sourceExtract: 'Conductor is available for macOS. […] Conductor is not available for Windows or Linux yet.',
    },
  },
  modelRestriction: {
  ...
  features: [
    ...
    },
    {
      ...
      screenshots: [],
      sourceUrl: 'https://www.conductor.build/docs/installation',
      sourceExtract: 'Get Conductor running on your Mac. […] Drag the Conductor app to your Applications folder.',
    },
    {
    ...
    },
    {
      ...
      sourceExtract: 'Create a pull request with Command + Shift + P. Conductor can help draft the PR description.',
    },
    {
